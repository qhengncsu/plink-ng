...
getcompactptrfromPgen <- function(pgen, variant_subset, xim, nsample) {
    .Call('_pgenlibr_getcompactptrfromPgen', PACKAGE = 'pgenlibr', pgen, variant_subset, xim, nsample)
}
...
HasSparseHardcalls <- function(pgen, variant_num, allele_num = 2L) {
    .Call('_pgenlibr_HasSparseHardcalls', PACKAGE = 'pgenlibr', pgen, variant_num, allele_num)
}
...
ReadSparseHardcalls <- function(pgen, variant_num, allele_num = 2L, return_ints = FALSE) {
    .Call('_pgenlibr_ReadSparseHardcalls', PACKAGE = 'pgenlibr', pgen, variant_num, allele_num, return_ints)
}
...
HasSparse <- function(pgen, variant_num, allele_num = 2L) {
    .Call('_pgenlibr_HasSparse', PACKAGE = 'pgenlibr', pgen, variant_num, allele_num)
}
...
ReadSparse <- function(pgen, variant_num, allele_num = 2L) {
    .Call('_pgenlibr_ReadSparse', PACKAGE = 'pgenlibr', pgen, variant_num, allele_num)
}
...
NewPvar <- function(filename, omit_chrom = FALSE, omit_pos = FALSE) {
    .Call('_pgenlibr_NewPvar', PACKAGE = 'pgenlibr', filename, omit_chrom, omit_pos)
}
...
GetVariantChrom <- function(pvar, variant_num) {
    .Call('_pgenlibr_GetVariantChrom', PACKAGE = 'pgenlibr', pvar, variant_num)
}
...
GetVariantPos <- function(pvar, variant_num) {
    .Call('_pgenlibr_GetVariantPos', PACKAGE = 'pgenlibr', pvar, variant_num)
}
...
GetVariantsById <- function(pvar, id) {
    .Call('_pgenlibr_GetVariantsById', PACKAGE = 'pgenlibr', pvar, id)
}
